...
export class FlexBasicElement extends HTMLElement {
  ...
  #sync() {
    ...
    const paddingInline = parseMaybeNumber(
      getAttr(this, 'padding-inline', 'paddingInline'),
    )
    const paddingBlock = parseMaybeNumber(
      getAttr(this, 'padding-block', 'paddingBlock'),
    )
    ...
    if (justifyContent !== undefined)
      setVar('--lobe-flex-justify', justifyContent)
    ...
    if (height !== undefined)
      setVar('--lobe-flex-height', getCssValue(height as any)!)
    else this.style.removeProperty('--lobe-flex-height')

    if (padding !== undefined)
      setVar('--lobe-flex-padding', getCssValue(padding as any)!)
...
export const NativeFlexBasicElement =
  'lobe-flex' as unknown as FC<FlexBasicProps>
